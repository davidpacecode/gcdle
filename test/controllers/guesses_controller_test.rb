...
class GuessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guess" do
    assert_difference("Guess.count") do
      post guesses_url, params: { guess: { game_id: @guess.game_id, guess_number: @guess.guess_number, value: @guess.value } }
    end
  ...
  test "should update guess" do
    patch guess_url(@guess), params: { guess: { game_id: @guess.game_id, guess_number: @guess.guess_number, value: @guess.value } }
